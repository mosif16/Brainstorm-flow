...
function buildPrompt(seed: SeedInput, n: number, attempt: number): string {
  ...
  return [
    'You are a principal product strategist helping a venture team invent standout app experiences.',
    `Generate ${n} distinct app concepts that respond directly to the seed inputs.`,
    'Every idea must describe a realistic mobile, web, or cross-platform app (or in-app capability) that could ship within six months.',
    'Assume the launch market is the United States unless the seed explicitly states a different geography, and reflect US cultural, regulatory, and platform expectations.',
    'Return JSON only using the provided schema.',
    'Requirements:',
    '- titles under 10 words and name the app or hero feature',
    '- description 2-3 sentences covering platform focus, primary user journey, signature features, and what makes it stand out for US users on day one',
    '- include a distinctive hook (novel mechanic, partnership, data unlock, or community twist) that signals creative differentiation',
    '- rationale 1 sentence tying the concept to the stated goal, the US audience insight, and the differentiator',
    '- risk summarises the biggest adoption or delivery risk in 1 sentence',
    `Goal: ${seed.goal}`,
